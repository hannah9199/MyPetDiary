...
<script type="text/javascript">
		function checkDuplicateId(  ){
			...
			window.open(url, 'mywin', 'height=150,width=200') ;
		}
	...
	<div id="main_container" align="center"
		...
		<div class="panel panel-default ">
			<div class="panel-heading" align="center">
				<font color="black" size = 3.5 ><b>회원 가입</b></font> 
			</div>
			<div class="panel-body sub_container">
				<form id="myform" name="myform" class="form-horizontal" role="form"
					...
					<div class="form-group">
						<label for="id"
							class="col-xs-3 control-label"><font size = 2><font color =red >*</font> 아이디</font></label>
						<div class="col-xs-<%=formright - 2%> ">
							<input type="text" name="id" id="id" class="form-control"
								placeholder="아이디를 입력해 주세요." value="${requestScope.bean.id}"
								onkeyup="isCheckFalse();"> <span class="err" id="spanid">${errid}</span>
						</div>
						<div class = "col-xs-0.5" align="left">
							<input type="button" class="btn btn-info button1" value="중복 검사"
								onclick="checkDuplicateId();">
						</div>
					</div>
					<div class="form-group">
						<label for="nickname"
							class="col-xs-3 control-label"><font size = 2><font color =red >*</font> 닉네임</font></label>
						<div class="col-xs-<%=formright - 2%> col-lg-<%=formright - 4%>">
					...
					<div class="form-group">
						<label for="email"
							class="col-xs-<%=formleft%> col-lg-<%=formleft%> control-label"><font size = 2><font color =red >*</font> 이메일</font> 
						</label>
						<div class="col-xs-<%=formright%> col-lg-<%=formright%>">
                ...
                <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-xs-<%=2%> col-lg-<%=2%>" align="left">
							<input type="button" class="btn btn-info button1" value="우편
							번호 찾기"
								onclick="findZipcode();">
						</div>
					...
					<%-- <div class="form-group">
						<label for="address1"
							class="col-xs-<%=formleft%> col-lg-<%=formleft%> control-label"><font size = 2>주소</font></label>
						<div class="col-xs-<%=formright%> col-lg-<%=formright%>">
					...
					<div class="form-group">
						<label for="address1"
							class="col-xs-<%=formleft%> col-lg-<%=formleft%> control-label"><font size = 2>
							주소</font></label>
						<div class="col-xs-<%=formright%> col-lg-<%=formright%>">
					...
					<div class="form-group">
						<label for="address2"
							class="col-xs-<%=formleft%> col-lg-<%=formleft%> control-label"><font size = 2>세부
							주소</font></label>
						<div class="col-xs-<%=formright%> col-lg-<%=formright%>">
					...
					<div class="form-group">
						<div class="col-xs-<%=14%> col-lg-<%=6%>" align="center">
							<button type="submit" class="btn btn-default"
								onclick="return checkForm();">
								<font size = 2><b>회원 가입</b></font>
							</button>
						</div>
					</div>
				</form>
