		...
		protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if (command == null) {
				...
				if (multi != null) {
					...
					System.out.println("MultipartRequest 객체를 구할 수 없습니다.");
				}
			} 
			...
			if (controller != null) {
				...
				if( method.equals("get")) {
					System.out.println(controller.toString() + "Get 호출 완료");
					controller.doGet(request, response);
					
				}else {
					System.out.println(controller.toString() + "Post 호출 완료");
					controller.doPost(request, response);
				}	
				
			} else {
				System.out.println("Command가 NULL 입니다."); 
			}		
		}
